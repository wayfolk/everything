...
import Engine from "./_components/_engine/Engine.mjs";
...
class Main extends HTMLElement
{
  ...
  createComponentInstances(fCB)
  {
    ...
    (
      [
        function(fCB) { this.components._engine = new Engine(fCB); }.bind(this),
  ...
  populateShadowDOM(fCB)
  {
    ...
    DOM.append(this.components._engine, this.domShadowRoot);
